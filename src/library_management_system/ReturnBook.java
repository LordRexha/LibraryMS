...
public class ReturnBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMemberName.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        txtMemberName.setText("membername");

        txtBook.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        ...
        txtReturnDate.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
    ...
    private void txtMemberIDKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtMemberIDKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            ...
            try {
                pst = connection.prepareStatement("SELECT m.name,b.bookname,i.returndate,DATEDIFF(NOW(),i.returndate) as elap FROM issuebook i JOIN book b ON i.bookid = b.id JOIN member m ON i.memberid = m.id and  i.memberid = ?");
                pst.setString(1, id);
                ResultSet rs = pst.executeQuery();
                if (rs.next() == false) {
