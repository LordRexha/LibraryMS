...
public class IssueBooks extends javax.swing.JFrame {
    ...
    public void displayTableIssueBookData() {
        ...
        try {
            pst = connection.prepareStatement("SELECT l.id,m.name,b.bookname,l.issueddate,l.returndate from issuebook l JOIN member m JOIN book b ON l.bookid = b.id;  ");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
                ...
                new String[]{
                    "ID", "Member ID", "Member Name", "Book", "Issued Date", "Return Date"
                }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        String issueDate = txtIssuedDate.getDateFormatString();
    ...
    private void txtBookActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
    }
